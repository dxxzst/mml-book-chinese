...
<p align="center">
  ...
  <b>图 3.11 投影到具有基 b₁, b₂ 的二维子空间 U 上。x ∈ ℝ³ 在 U 上的投影 π_U(x) 可以表示为 b₁, b₂ 的线性组合，位移向量 x − π_U(x) 同时与 b₁ 和 b₂ 正交。</b><br>
</p>
...
<p align="center">
  ...
  <b>图 3.13 投影到仿射空间。(a) 原始设定；(b) 平移 −x₀ 使得 x − x₀ 可以投影到方向空间 U 上；(c) 将投影平移回 x₀ + π_U(x − x₀)，得到最终的正交投影 π_L(x)。</b><br>
</p>
